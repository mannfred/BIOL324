...
# title: "<span style='font-size: 30px'> Mapping species distributions using R and GBIF </style>" 
author: 
date: ""
output: 
  word_document:
...
2. completed some preliminary reading on why/how R is useful for data science, <br>

3. completed the R primer _The Basics_ and _Work With Data_, <br>

4. researched 2-3 of your favourite plant groups for creating a species distribution map, <br>

5. navigated through the GBIF website and understand what it is and why it exists. 
...
1. experience using R and its most common functions, <br>

2. familiarity with GBIF and the types of data that can be obtained, <br>

3. the tools and knowledge needed to create your own species distribution maps as part of a taxonomic research programme, <br>
