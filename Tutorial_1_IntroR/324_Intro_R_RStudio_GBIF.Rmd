...
3. be familiar with the layout of RStudio, and understand how to install packages and navigate the `nycflights13` dataset (could also do our own exercises with the `iris` dataset, but see https://stat.ethz.ch/R-manual/R-devel/library/datasets/html/iris.html for problems), &nbsp;
