...
Species in the genus *Lillium* (which can be bought as ornamentals from most florists) are nice and big, and do a great job of displaying the typical flower structure of lily-like monocots. Note the undifferentiated sepal and petal whorls (thus we call them tepals) and unfused parts in 3's. How many carpels do you think make up the ovary of this flower? Ovaries can either be superior or inferior depending on the family.
...
Fruit in these families are typically capsules or berries. Here, you can see a dehisced *Lillium* capsule (notice the cool teeth in between the ovary segments) and winged seeds. 
