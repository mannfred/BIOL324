...
You must write a short report (1-2 pages) detailing the types of plants you found for your iNaturalist project. Your report should focus on the different types of plants you found (growth form, size, geographic range, flower/fruit types, ecology, etc.) and a discussion of their phylogenetic relationships. Try to reconcile your experience with these plants in the field with what you've learned from your phylogenetic tree (e.g., do the plants that are more closely related on your tree share morphological traits?). 

Report requirements:

- Include a simple phylogenetic tree (see Lab 5 and KNOWLEDGE CHECK 5.4).
  ...
  - Your figure must include a caption.
- You must cite your figure in the text using proper citation formatting. 
- You should include at least 2(?) scientific references that are properly cited in the text, and included in a References section at the end of your report.
