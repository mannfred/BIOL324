...
The pictures below display *Antirrhinum* sp. (snapdragons). We will go into the Scrophularioid families in greater detail in Lab 6. In this case the petals are fused, which makes it a little bit trickier to tell how many petals there are...you can count the number of petal lobes.
...
**-KNOWLEDGE CHECK-**  
Draw the above pictured fruits and indicate the following:  
